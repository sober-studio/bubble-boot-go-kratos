...
const (
	Upload_UploadFile_FullMethodName = "/api.upload.v1.Upload/UploadFile"
)
...
func (c *uploadClient) UploadFile(ctx context.Context, in *UploadFileRequest, opts ...grpc.CallOption) (*UploadFileReply, error) {
...
func (UnimplementedUploadServer) UploadFile(context.Context, *UploadFileRequest) (*UploadFileReply, error) {
...
func _Upload_UploadFile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UploadServer).UploadFile(ctx, req.(*UploadFileRequest))
	}
